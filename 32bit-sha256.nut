...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//                                                   //
//      THIS HASH CODE IS MODIFIED FOR A 32 BIT      //
//      SYSTEM. IT DOES NOT WORK THE SAME AS         //
//      REGULAR SHA256. BE WARNED!                   //
//                                                   //
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
function sha256(message){
    ...
    while(((messageBytes.len()*8 + 32) % 512) != 0) {
    ...
    foreach(M in blocks){
        ...
        for (local t=0;t<64;t++){
            if (t <16){
                ...
                local schedule = IntToBytesBE(term1 + term2 + term3 + term4,4)
                W.append(schedule)
            }
        ...
        for (local t=0;t<64;t++){
            t1 = h + capsigma1(e) + Ch(e,f,g) + K[t] + BytesToIntBE(W[t])
